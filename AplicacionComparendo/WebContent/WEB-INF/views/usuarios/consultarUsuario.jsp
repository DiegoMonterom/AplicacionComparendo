...
<spring:url value="../usuarios/consultarUsuario" var="urlForm"></spring:url>
...
<body>
	...
	<div class="container theme-showcase" role="main">
		<div class="page-header">
			<h3 class="blog-title">
				<span class="label label-success">Ingrese el numero de identificiacion de la persona</span>
			</h3>
		</div>
