...
<spring:url value="../usuarios/consultarUsuario" var="urlForm1"></spring:url>
<spring:url value="../usuarios/modificarUsuario" var="urlForm"></spring:url>
...
<body>
	...
	<div class="container theme-showcase" role="main">
		<div class="page-header">
			<h3 class="blog-title">
				<span class="label label-success">Ingrese los datos a modificar de la persona</span>
			</h3>
		</div>
	
		<form:form action="${urlForm1}" method="post" modelAttribute="usuario">
			<div class="row">
